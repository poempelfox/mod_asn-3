...
you run the SQL script provided with the ip4r sources, in later versions you instead
register an extension::

    su - postgres
    psql -c "CREATE EXTENSION ip4r" template1                     # on Debian/Ubuntu >= postgre 9.1
    psql -f /usr/share/postgresql/8.4/contrib/ip4r.sql template1  # on Ubuntu < postgre 9.1
