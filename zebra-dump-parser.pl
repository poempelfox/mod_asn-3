...
#
# Note: This program was not created as part of the mirrorbrain/mod_asn
# project, it is only bundled with it for convenience (you need it to
# import IPv6 AS data).
# It was written by Marco d'Itri <md@linux.it> and is available at
